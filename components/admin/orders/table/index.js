  ...
  return (
    <React.Fragment>
      <TableRow sx={{ '& > *': { borderBottom: 'unset' } }}>
        ...
        <TableCell align="right">{row.paymentMethod=="paypal"?"Paypal":row.paymentMethod=="credit_card"?"Credit Card":"Cash on Delivery"}</TableCell>
        <TableCell align="right">{row.isPaid? (<img className={styles.ver} src="../../../images/verified.png"/>):(<img className={styles.ver} src="../../../images/unverified.png"/>)}</TableCell>
                ...
                <TableBody>
                  
                   {
                    row.products.map((p)=>(
                        <TableRow key={p._id}>
                        <TableCell component="th" scope="row">
                            <img src={p.image} className={styles.table__productImg} />
                        ...
                        <TableCell align="left"></TableCell>
                        <TableCell align="left" style={{padding:"20px 0 20px 20px"}}><b style={{fontSize:"20px"}} > {row.total} £ </b></TableCell>
                      </TableRow>
